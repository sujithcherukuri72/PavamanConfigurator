...
This folder contains all static assets used in the pavaman Drone Configurator application.
...
- **Branding:** "pavaman Drone Configurator" title text
...
3. Point to `avares://pavamanDroneConfigurator.UI/Assets/Images/splash.png`
...
```xml
<!-- Background -->
<ImageBrush Source="avares://pavamanDroneConfigurator.UI/Assets/Images/background.jpg"/>

<!-- Logo -->
<Image Source="avares://pavamanDroneConfigurator.UI/Assets/Images/logo.ico"/>

<!-- Logo with name -->
<Image Source="avares://pavamanDroneConfigurator.UI/Assets/Images/logo-withname.ico"/>
```

### In Code
```csharp
var logoUri = new Uri("avares://pavamanDroneConfigurator.UI/Assets/Images/logo.ico");
